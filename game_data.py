...
class Location:
   ...
   def __init__(self, location_num: str, points: str, short_description: str, long_description: str) -> None:
       ...
       self.actions = self.available_actions(int(location_num[-1]))
       self.items =
   ...
   def available_actions(self, location_num: int) -> list[str]:
       """
...
class World:
   ...
   def load_location(self, location_data: TextIO) -> list[Location]:
       ...
       the_location = [[] for _ in range(32)]
       cur_location = 0
       for element in location_raw:
           if element == '\n':
               cur_location += 1
               pass
           the_location[cur_location].append(element.rstrip())
       final_location = []
       for element in the_location:
           final_location.append(Location(element[0], element[1], element[2], element[3]))
